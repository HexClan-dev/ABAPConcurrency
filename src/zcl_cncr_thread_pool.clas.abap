...
CLASS zcl_cncr_thread_pool IMPLEMENTATION.
  ...
  METHOD get_server_group.
    ...
    LOOP AT lt_rzllitab ASSIGNING FIELD-SYMBOL(<ls_rzllitab>).
      ...
      IF sy-subrc = 0.
        ...
        ls_srv_group-classname  = <ls_rzllitab>-classname.
  ...
  METHOD add_thread.
    ...
    ls_runnable-classname = me->ms_server_group-classname.
  ...
  METHOD execute.
    ...
    LOOP AT me->mt_runnable
      ...
      TRY.
          ...
          DATA(lv_is_running) = lo_runnable->run( iv_task_name = lv_task_id ).
